...
All notable changes to the `rails-testing-v8` plugin are documented in this file.
...
Initial release of the `rails-testing-v8` plugin. Projects the official [Rails 8.1.3 testing guide](https://guides.rubyonrails.org/testing.html) as an auto-invoked Claude Code skill, with every claim verified against `rails/rails@v8.1.3` source.
...
- Per-reference source-traceability tables citing Rails source at the `v8.1.3` tag.
