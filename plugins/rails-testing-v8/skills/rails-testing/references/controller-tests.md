...
| `assert_response`, `assert_redirected_to` (used throughout) — cross-linked | `actionpack/lib/action_dispatch/testing/assertions/response.rb` lines 33, 60; see [writing-tests.md](writing-tests.md) |
| `articles(:one)` fixture accessor — cross-linked | `activerecord/lib/active_record/test_fixtures.rb`; see [test-database.md](test-database.md) |
